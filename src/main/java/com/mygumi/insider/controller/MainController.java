...
public class MainController {
    ...
    public ResponseEntity<?> oauthLogin() throws IOException {
        ...
        headers.setLocation(URI.create("https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=d17798d61b78b91a8abfca3e6f914fe5&redirect_uri=https://mygumiworld-backend-sxxzy.run.goorm.io/api/auth/kakao&prompt=login"));
    ...
    public ResponseEntity<?> oauthLogout(@ApiParam("value = 로그인 된 유저의 JWT 토큰 값")  @RequestHeader("Authorization") String jwt) throws IOException {
        ...
        HttpHeaders headers = new HttpHeaders();
        headers.setLocation(URI.create("https://kauth.kakao.com/oauth/logout?client_id=d17798d61b78b91a8abfca3e6f914fe5&logout_redirect_uri=https://mygumiworld-backend-sxxzy.run.goorm.io/api/auth/kakao"));
        return new ResponseEntity<>(headers, HttpStatus.MOVED_PERMANENTLY);
    }
