...
public class WeatherServiceImpl implements WeatherService {
	...
	public Map<String, Object> getWeather() throws Exception {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=" + URLEncoder.encode(weatherKey, "UTF-8")); /*Service Key*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("base_time","UTF-8") + "=" + URLEncoder.encode(Hour, "UTF-8")); /*06시 발표(정시단위) */
        urlBuilder.append("&" + URLEncoder.encode("nx","UTF-8") + "=" + URLEncoder.encode("86", "UTF-8")); /*예보지점의 X 좌표값*/
        urlBuilder.append("&" + URLEncoder.encode("ny","UTF-8") + "=" + URLEncoder.encode("95", "UTF-8")); /*예보지점의 Y 좌표값*/
